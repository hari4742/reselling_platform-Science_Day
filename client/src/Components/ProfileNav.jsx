...
const ProfileNav = () => {
    ...
    return ( 
        ...
        <img src={'http://localhost:5000'+user.propic} alt='user profile pric'/>
         <Link style={{textDecoration:"none"}} to={`/profile/${user.user_id}/${user.first_name+user.last_name}/edit_avatar`}><i className="fas fa-pen"><BsPencilSquare/></i></Link>
